                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative pt-2">
                      ...
                      <button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border-2 border-blue-600"
                      >
                        {processingPayment ? (
                          <>
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-white border-2 border-green-500 text-green-700 rounded-xl font-medium hover:bg-green-50 transition-all flex items-center justify-center gap-2"
                    >
