...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-amber-50">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t shadow-xl">
            <div className="px-4 py-6 space-y-4">
              <button
                onClick={() => { router.push('/#features'); setMobileMenuOpen(false); }}
                className="block w-full text-left py-2 text-gray-700 hover:text-green-600 transition"
              >
                Fonctionnalités
              </button>
              <button
                onClick={() => { router.push('/#modes'); setMobileMenuOpen(false); }}
                className="block w-full text-left py-2 text-gray-700 hover:text-green-600 transition"
              >
                Modes de jeu
              </button>
      ...
      {/* Contenu principal */}
      <div className="relative z-10 min-h-screen flex flex-col justify-center items-center px-4 py-12 pt-24">
        {/* Logo et titre */}
